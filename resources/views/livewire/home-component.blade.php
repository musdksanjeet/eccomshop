                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul id="sponsors" class="tooltip-hover">
                                ...
                                <li data-toggle="tooltip" title="{{$scategory->name}}" data-original-title="{{$scategory->name}}"> <a
                                        href="{{route('home.services_by_category',['category_slug'=>$scategory->slug])}}"><img src="{{ asset('images/categories') }}/{{$scategory->image}}"
                ...
                <div>
                    <div class="container">
                        ...
                        <div class="portfolioContainer" style="margin-top: -50px;">
                            @foreach($fserverices as $service)
